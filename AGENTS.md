...
- `simwing_scene_fluid_geometry`: builds a bounded deterministic cell-major
  ...
  vertices/edges and explicitly marks opening and grid-edge endpoints. None of
  these products is a cut-cell volume or fluid-region classification.
...
There are 123 configured tests on Windows. The Fortran-reference test is
