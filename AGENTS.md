...
- `simwing_scene_fluid_opening_cap`: builds topology-only virtual caps for the
  ...
  bounded surface-sweep ledger; it does not sample or solve fluid flux.
...
There are 138 configured tests on Windows. The Fortran-reference test is
