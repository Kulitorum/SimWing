...
- `simwing_scene_fluid_geometry`: builds a bounded deterministic cell-major
  ...
  with one consistent authored region pair. None of these products is a
  cut-cell volume or fluid-region classification.
...
There are 124 configured tests on Windows. The Fortran-reference test is
