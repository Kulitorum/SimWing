...
- `simwing_scene_fluid_geometry`: builds a bounded deterministic cell-major
  ...
  nested loops or sealing open chains. None of these products is a cut-cell
  volume or complete fluid-region classification.
- `simwing_scene_fluid_quadrature`: converts those unique cell/face area owners
  ...
  conservative Structure transfer. It does not calculate fluid traction.
...
There are 125 configured tests on Windows. The Fortran-reference test is
