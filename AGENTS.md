...
- `simwing_scene_fluid_pressure_operator`: assembles those links into a
  ...
  zero. Physical RHS/flux construction and velocity projection remain future
  stages.
...
There are 146 configured tests on Windows. The Fortran-reference test is
