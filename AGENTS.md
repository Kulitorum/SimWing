...
- `simwing_amr_external_flow`: opt-in AMReX 26.06 production-grid evaluation.
  ...
  positive Y; it does not yet advance momentum. All are excluded from ordinary builds.
