...
- `simwing_scene_fluid_geometry`: builds a bounded deterministic cell-major
  ...
  references without treating their summed measures as unions. None of these
  products is a cut-cell volume or fluid-region classification.
...
There are 122 configured tests on Windows. The Fortran-reference test is
