...
- `simwing_scene_fluid_cell_volume`: reconstructs bounded deterministic sparse
  ...
  with whole-surface region volumes. Projection-connected opening flux,
  nonplanar/concave mouths,
