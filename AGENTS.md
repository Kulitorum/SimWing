...
- `scene_pressure_cell_mimetic_conductance_phase_refinement_audit.{h,cpp}`
  ...
  32 requested sample records, nested terminal responses, conditional
  ...
  `0.902570/0.20104` at `2^3`/`4^3`/`8^3`/`16^3`; the `16^3` range is
  `0.624544`-`1.141234`. The former five `8^3` rejections were
  ...
  unchanged `1e-10` algebraic tolerance. Tiny `16^3` complementary boundary
  ...
  auxiliary core is numerically singular. This removes graph censoring from the
