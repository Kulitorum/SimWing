...
- `simwing_scene_fluid_pressure_operator`: assembles those links into a
  ...
  becoming implicit sealed walls. It applies only
  the geometry operator; RHS construction and projection remain future stages.
...
There are 145 configured tests on Windows. The Fortran-reference test is
