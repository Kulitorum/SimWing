...
- `simwing_scene_fluid_pressure_face_link`: binds those pressure unknowns
  ...
  centroids. Material/open-chain/coplanar overlap and ambiguous inactive faces
  remain explicit and unlinked.
- `simwing_scene_fluid_pressure_operator`: assembles those links into a
  ...
  embedded off-face openings join their regions; unresolved faces reject
  instead of becoming implicit sealed walls. Its deterministic component-wise
  CG solve
