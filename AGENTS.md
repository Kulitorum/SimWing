...
- `src/fsi/fluid/porous_interface.{h,cpp}` applies a calibrated normal
  ...
  identity, but is not moving cut-cell topology or yet composed into a complete
  second-order coupled flow integrator.
