...
- `simwing_scene_fluid_geometry`: builds a bounded deterministic cell-major
  ...
  barycentric surface polygons into each exact cell. None of these products is
  a cut-cell volume or fluid-region classification.
...
There are 118 configured tests on Windows. The Fortran-reference test is
