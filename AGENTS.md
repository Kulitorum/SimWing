...
- `scene_pressure_cell_operator_phase_refinement_audit.{h,cpp}` nests that
  ...
  the phase set before the paired response audit. A graph-independent shadow
  spectrum is the next required discriminator.
