...
- `simwing_porous_sheet_case`: Qt-free fixed-topology midpoint oracle coupling
  ...
  fluid fields, and the last accepted ledger with exact next-frame replay. It
  deliberately rejects motion beyond one MAC segment.
