...
- `simwing_moving_porous_flow_case`: Qt-free owning-frame canonical for the
  ...
  and pump crossings with both stage epochs and conservation ledgers. It is not
  yet exposed as a CLI case or coupled to Structure.
