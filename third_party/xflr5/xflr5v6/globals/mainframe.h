...
class MainFrame : public QMainWindow
{
    ...
    public:
        ...
        bool loadSettings();
        bool lepImportLepWing(QString const &xflr5DirPath, QString &errorMessage); /**< LEP embedding patch: import a LEparagliding Section-36 export (rib *.dat foils + *.xwimp wing) as a wing-only Plane */
