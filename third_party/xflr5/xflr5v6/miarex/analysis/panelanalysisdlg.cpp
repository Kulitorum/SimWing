...
{
    setMinimumWidth(700);// something changed in Qt6 sizeHint is ignored
...
void PanelAnalysisDlg::showEvent(QShowEvent *pEvent)
{
...
void PanelAnalysisDlg::hideEvent(QHideEvent *pEvent)
{
