...
void WPolarDlg::showEvent(QShowEvent *pEvent)
{
...
void WPolarDlg::hideEvent(QHideEvent *pEvent)
{
...
void WPolarDlg::onMethod()
{
    ...
    // unused
    if(m_prbPanelMethod->isChecked()) s_WPolar.setBoundaryCondition(xfl::DIRICHLET);
    else                              s_WPolar.setBoundaryCondition(xfl::NEUMANN);
