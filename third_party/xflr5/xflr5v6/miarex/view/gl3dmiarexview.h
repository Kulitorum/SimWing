...
class gl3dMiarexView : public gl3dXflView
{
    ...
    private:
        ...
        void glMakePanels(QOpenGLBuffer &vboPanels, const QVector<Panel> &pPanel, PlaneOpp const *pPOpp);
    ...
    public:
        ...
        QOpenGLBuffer m_vboWake, m_vboWakeEdges;
