...
void ManageFoilsDlg::showEvent(QShowEvent *pEvent)
{
...
void ManageFoilsDlg::hideEvent(QHideEvent*pEvent)
{
...
void ManageFoilsDlg::setupLayout()
{
    ...
    m_pFoilModel->setHeaderData(6, Qt::Horizontal, tr("TE Flap (")+DEGCHAR+")");
    m_pFoilModel->setHeaderData(7, Qt::Horizontal, tr("TE XHinge"));
    m_pFoilModel->setHeaderData(8, Qt::Horizontal, tr("TE YHinge"));
    m_pFoilModel->setHeaderData(9, Qt::Horizontal, tr("LE Flap (")+DEGCHAR+")");
