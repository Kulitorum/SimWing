...
void XDirect::onTaskFinished(Polar *pPolar)
{
    ...
    //Data save for Xnverse initialization
    m_XFoil = m_pXFADlg->m_pXFoilTask->m_XFoilInstance;
    emit projectModified();
}
    ...
    QGroupBox *pAnalysisBox = new QGroupBox(tr("Analysis settings"));
    {
        ...
        QVBoxLayout *pAnalysisGroup = new QVBoxLayout;
        {
            ...
            QGridLayout *pSequenceGroupLayout = new QGridLayout;
            {
                ...
                QLabel *plabDeltaAlpha = new QLabel("<p>&Delta;=</p>");
                plabDeltaAlpha->setAlignment(Qt::AlignRight);
                ...
                pSequenceGroupLayout->addWidget(plabAlphaMin,    1,1);
                pSequenceGroupLayout->addWidget(plabAlphaMax,    2,1);
                pSequenceGroupLayout->addWidget(plabDeltaAlpha,  3,1);
