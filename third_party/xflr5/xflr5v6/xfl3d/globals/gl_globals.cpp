...
void glMakePanels(QOpenGLBuffer &vboPanels, QVector<Panel> const &panels, QColor backcolor)
{
...
void glMakePanelEdges(QOpenGLBuffer &vboEdges, QVector<Panel> const &panels)
{
    // Edges:
    //      nPanels
    //      x 4 edges
