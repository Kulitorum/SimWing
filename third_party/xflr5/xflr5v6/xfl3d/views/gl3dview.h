...
//        void getMemoryStatus(int &total_mem_kb, int &cur_avail_mem_kb);
    ...
    protected:
        ...
        void paintThinArrow(Vector3d const &origin, const Vector3d& arrow, LineStyle const &ls, QMatrix4x4 const ModelMatrix);
        void paintThinArrow(Vector3d const &origin, const Vector3d& arrow, QColor const &clr, float w, Line::enumLineStipple stipple, QMatrix4x4 const ModelMatrix);
