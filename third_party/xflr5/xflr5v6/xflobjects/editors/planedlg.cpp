...
void PlaneDlg::hideEvent(QHideEvent *pEvent)
{
            ...
            QGridLayout *pLeftLayout = new QGridLayout;
            {
                ...
                QGroupBox *pMainWingBox = new QGroupBox(tr("Main Wing"));
                {
                    QGridLayout *pMainWingLayout = new QGridLayout;
                    {
                        ...
                        QLabel *plab1 = new QLabel(tr("x="));
                        QLabel *plab2 = new QLabel(tr("z="));
                        QLabel *plab3 = new QLabel(tr("Tilt Angle="));
                        ...
                        QLabel *plab4 = new QLabel("<p>&deg;</p>");
                        pMainWingLayout->addWidget(m_ppbDefineWing, 2,1);
                        pMainWingLayout->addWidget(m_ppbImportWing, 3,1);
                        pMainWingLayout->addWidget(plab1,           2,2);
                        pMainWingLayout->addWidget(plab2,           3,2);
                        pMainWingLayout->addWidget(plab3,           4,2);
                        ...
                        pMainWingLayout->addWidget(plab4,           4,4);
                ...
                QGroupBox *pMainWing2Box = new QGroupBox(tr("Wing 2"));
                {
                    QGridLayout *pMainWing2Layout = new QGridLayout;
                    {
                        ...
                        QLabel *plab11 = new QLabel(tr("x="));
                        QLabel *plab12 = new QLabel(tr("z="));
                        QLabel *plab13 = new QLabel(tr("Tilt Angle="));
                        plab11->setAlignment(Qt::AlignRight | Qt::AlignVCenter);
                        plab12->setAlignment(Qt::AlignRight | Qt::AlignVCenter);
                        plab13->setAlignment(Qt::AlignRight | Qt::AlignVCenter);
                        ...
                        QLabel *plab14 = new QLabel("<p>&deg;</p>");
                        ...
                        pMainWing2Layout->addWidget(plab11,           2,2);
                        pMainWing2Layout->addWidget(plab12,           3,2);
                        pMainWing2Layout->addWidget(plab13,           4,2);
                        ...
                        pMainWing2Layout->addWidget(plab14,           4,4);
                    }
                ...
                QGroupBox *pStabBox = new QGroupBox(tr("Elevator"));
                {
                    QGridLayout *pStabLayout = new QGridLayout;
                    {
                        ...
                        QLabel *plab24   = new QLabel("<p>&deg;</p>");
                        ...
                        pStabLayout->addWidget(plab24,           5,4);
                ...
                QGroupBox *pFinBox = new QGroupBox(tr("Fin"));
                {
                    QGridLayout *pFinLayout = new QGridLayout;
                    {
                        ...
                        QLabel *plab35 = new QLabel("<p>&deg;</p>");
                        ...
                        pFinLayout->addWidget(plab35,          5,4);
                    }
