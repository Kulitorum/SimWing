...
void WingDlg::setupLayout()
{
    ...
    m_pspLeftSide = new QSplitter(Qt::Vertical, this);
    {
        QFrame *pDataFrame = new QFrame;
        {
            QVBoxLayout *pDataLayout = new QVBoxLayout;
            {
                ...
                m_pWingModel->setHeaderData(0, Qt::Horizontal, tr("y (")+Units::lengthUnitLabel()+")");
                m_pWingModel->setHeaderData(1, Qt::Horizontal, tr("chord (")+Units::lengthUnitLabel()+")");
                m_pWingModel->setHeaderData(2, Qt::Horizontal, tr("offset (")+Units::lengthUnitLabel()+")");
    ...
    QFrame *pDataWidget = new QFrame(this);
    {
        QGridLayout *pDataLayout = new QGridLayout;
        {
            ...
            QLabel *lab30 = new QLabel("<p>&deg;</p>");
