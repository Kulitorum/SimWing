            ...
            for (int j=0; j<m_xPanels[i]; j++)
            {
                ...
                for (int k=0; k<sideLineCount()-1; k++)
                {
                    ...
                    for (int l=0; l<m_hPanels[k]; l++)
                    {
                        ...
                        panel.m_Vtx[0] = nodes.at(panel.m_iTA);
                        panel.m_Vtx[1] = nodes.at(panel.m_iTA);
                        panel.m_Vtx[2] = nodes.at(panel.m_iTA);
                        panel.m_Vtx[3] = nodes.at(panel.m_iTA);
