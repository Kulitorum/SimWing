...
void Panel::setPanelFrame()
{
    ...
    setPanelFrame(m_Vtx[0], m_Vtx[1], m_Vtx[2], m_Vtx[3]);
}
...
{
    return sqrt( (m_Vtx[1].y - m_Vtx[0].y)*(m_Vtx[1].y - m_Vtx[0].y)
                +(m_Vtx[1].z - m_Vtx[0].z)*(m_Vtx[1].z - m_Vtx[0].z));
}
...
*/
double Panel::sourceNASA4023(Vector3d const &C,  Vector3d &V) const
{
 ...
 */
double Panel::doubletNASA4023(Vector3d const &C, Vector3d &V) const
{
    Vector3d const *m_pR[5];
...
void Panel::printPanel()
{
    ...
    setPanelFrame(m_Vtx[0], m_Vtx[1], m_Vtx[2], m_Vtx[3]);
    m_Vtx[0].listCoords("  LA");
    m_Vtx[1].listCoords("  LB");
    m_Vtx[2].listCoords("  TA");
    m_Vtx[3].listCoords("  TB");
