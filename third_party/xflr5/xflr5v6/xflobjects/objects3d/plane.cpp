...
QString Plane::planeData(bool) const
{
    ...
    str1 = QString(QObject::tr("TipTwist       =")+"%1").arg(m_Wing[0].tipTwist(), 10,'f', 3) + DEGCHAR;
    props += str1+"\n";
    ...
    str1 = QString(QObject::tr("Root-Tip Sweep =")+"%1").arg(m_Wing[0].averageSweep(), 10,'f',3) + DEGCHAR;
    props += str1;
