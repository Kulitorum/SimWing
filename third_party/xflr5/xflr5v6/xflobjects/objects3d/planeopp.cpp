...
*/
PlaneOpp::PlaneOpp(Plane const*pPlane, WPolar const*pWPolar, int PanelArraySize)
{
    m_PlaneName   = "";
    m_WPlrName    = "";
                                     ...
                                     double mtoUnit, double kgtoUnit, double mstoUnit)
{
    ...
    strong  = QString("V"+INFCHAR+"  =%1 ").arg(m_QInf*mstoUnit,7,'f',3);
    planeOppProperties += "\n"+strong + speedUnitLabel+"\n";

    strong  = QString(ALPHACHAR +"   =%1").arg(m_Alpha,7,'f',2);
    planeOppProperties += strong +DEGCHAR+"\n";
    ...
    {
        strong  = QString(BETACHAR+"  = %1").arg(m_Beta,7,'f',2);
        planeOppProperties += strong +DEGCHAR+"\n\n";
    }
